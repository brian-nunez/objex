module github.com/brian-nunez/objex/examples/aws

go 1.22.2

replace github.com/brian-nunez/objex => ../../

replace github.com/brian-nunez/objex/drivers/aws => ../../drivers/aws

require github.com/brian-nunez/objex/drivers/aws v0.0.0
